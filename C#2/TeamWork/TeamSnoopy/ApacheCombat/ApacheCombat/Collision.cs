...
class Collision
{
    ...
    public static void HandleObstacleCollisionsWithShots(Obstacle obstacle, List<Shot> shots, ref bool hit, int lives, ref BigInteger score, int bombs)
    {
    ...
    public static void NucklearBombExplosion(List<Obstacle> obstacles, ref BigInteger score)
    {
