...
namespace WorkingWithData.Areas.Administration.Controllers
{
    ...
    public class TweetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Text,UserId")] Tweet tweet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Text,UserId")] Tweet tweet)
        {
            if (ModelState.IsValid)
            {
