namespace LybrarySystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LybrarySystem.Models.LybrarySystemDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "LybrarySystem.Models.ApplicationDbContext";
        }

        protected override void Seed(LybrarySystem.Models.LybrarySystemDbContext context)
        {
