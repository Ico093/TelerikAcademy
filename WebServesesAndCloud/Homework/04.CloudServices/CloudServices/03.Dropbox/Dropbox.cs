...
class Dropbox
{
    ...
    private const string DropboxAppKey = "7jjhb7z6wrxhq3u";
    private const string DropboxAppSecret = "t50htjthk9fg410";
    ...
    static void Main()
    {
        ...
        Entry uploadFileEntry = dropbox.UploadFileAsync(
            new FileResource("D:\\Kartinki i Snimki\\Kartinki\\cepesh_2.jpg"),
            "/" + newFolderName + "/dupe.jpg").Result;
